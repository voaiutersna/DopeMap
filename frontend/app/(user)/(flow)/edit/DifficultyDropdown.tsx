...
export default function DifficultyDropdown({
  ...
  return (
    <div className="relative w-full" ref={containerRef}>
       ...
       <div className={`absolute  w-full bg-[#1e1f1f] border-gray-500 rounded-md shadow-lg z-10 overflow-hidden ${open ? "opacity-100 max-h-screen  pointer-events-auto": "opacity-0 max-h-0 pointer-events-none"} duration-500`}>
  {difficulties.map((d) => (
    <button
      key={d.value}
      type="button"
